        ...
        if (!empty($usuario)) {
            ...
            if (mysqli_num_rows($resultado_1) > 0) {
                ...
                if (mysqli_num_rows($resultado_2) == 0) {
                    ...
                    $sql_query_3 = "INSERT INTO `archivos_compartidos` (`Usuario_local`, `Usuario_compartido`, `Nombre`, `Tamaño`, `Identificador`)
               VALUES ('" . $id . "', '" . $usuario . "', '" . $nombre_archivo . "', '" . $peso_archivo . "', '" . $identificador_archivo . "')";
